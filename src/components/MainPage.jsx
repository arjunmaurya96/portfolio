...
const SKILLS = {
  Frontend:  [
    { name:"React.js",      level:95 }, { name:"Next.js",        level:88 },
    { name:"TypeScript",    level:85 }, { name:"Tailwind CSS",    level:92 },
    { name:"Redux / Zustand", level:82 }, { name:"HTML5 / CSS3",  level:97 },
  ],
  Backend:   [
    { name:"Node.js",       level:93 }, { name:"Express.js",     level:91 },
    { name:"REST APIs",     level:94 }, { name:"GraphQL",         level:78 },
    { name:"Socket.io",     level:80 }, { name:"JWT / Auth",      level:88 },
  ],
  Database:  [
    { name:"MongoDB",       level:92 }, { name:"PostgreSQL",      level:80 },
    { name:"Redis",         level:75 }, { name:"MySQL",            level:82 },
    { name:"Firebase",      level:78 }, { name:"Mongoose ODM",    level:90 },
  ],
  "Tools & DevOps": [
    { name:"Git / GitHub",  level:95 }, { name:"Docker",          level:78 },
    { name:"AWS (EC2/S3)",  level:74 }, { name:"Vercel / Netlify", level:90 },
    { name:"VS Code",       level:97 }, { name:"Postman / Swagger", level:92 },
  ],
};
...
const EDUCATION = [
  { degree:"Diploma in Computer Science", institution:"Polytechnic Institute", year:"2016–2019", grade:"71%", icon:"🎓" },
  { degree:"12th (PCM)",                  institution:"State Board",           year:"2015–2016", grade:"60%", icon:"📚" },
  { degree:"10th",                        institution:"State Board",           year:"2013–2014", grade:"81%", icon:"🏫" },
];
...
function Navbar({ isDark, setDarkMode, tc, scrollTo, mobileNav, setMobileNav }) {
  ...
  return (
    <nav className={`fixed top-1 left-0 right-0 z-40 transition-all duration-500 ${
      scrolled ? "mx-4 md:mx-8 lg:mx-16 rounded-2xl" : ""
    }`}
      style={scrolled ? {
    ...
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute inset-0 opacity-5"
          style={{ backgroundImage: `linear-gradient(${isDark?"#fff":"#000"} 1px,transparent 1px),linear-gradient(90deg,${isDark?"#fff":"#000"} 1px,transparent 1px)`,
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border mb-6 animate-fade-in"
              ...
              <span className="mono-font text-xs tracking-widest uppercase">Available for hire · 5+ Years Exp</span>
            </div>
            ...
            <p className="text-base md:text-lg max-w-xl mx-auto lg:mx-0 leading-relaxed mb-8"
              ...
              Building scalable, high-performance web applications using the MERN stack.
              Passionate about clean code, great UX, and solving complex problems elegantly.
            </p>

            {/* Stats row */}
            <div className="flex items-center gap-8 justify-center lg:justify-start mb-8">
              {[["5+","Years Exp"],["50+","Projects"],["20+","Happy Clients"]].map(([num, label]) => (
          ...
          <div className="space-y-6">
            <div className="rounded-2xl p-6" style={cardStyle}>
              ...
              <p className="leading-relaxed text-sm" style={{ color: isDark?"#94a3b8":"#64748b" }}>
                ...
                with <strong style={{ color: isDark?"#e2e8f0":"#1e293b" }}>5+ years</strong> of professional experience building
